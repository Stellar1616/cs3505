 ...
 * for large numbers stored in strings.  The algorithms below
 * may be used as a starting point for your code, but it is up to
 * you to make sure they work in every case.  Note:  This is not robust.
 ...
 * to them.  (That is the primary reason for using strings for number
...
int main ()
{
  // A quick test or two - I'd deleted the addition test, feel free to re-add it.
  ...
  //   returning a 0.  (We don't make any use of this error code.)
...
// Other really useful functions you may want to write over the weekend
